...
export default function DTM({ asset }) {
	...
	return (
		<div className="overview-box">
			<img className="small-overview" src={`${SERVER_STORAGE_URL}/${asset.preview_image}`} alt="orthomosaic" onClick={() => _navigateToDTM()} />
			<svg width="24" height="24" viewBox="0 0 24 24" className="overview-visible" style={{ cursor: 'pointer' }} onClick={() => _toggleTerrain()}>
				<path fill="#000" d={eyeIcon} />
			</svg>
			<p className="overview-text">DTM</p>
		</div>
	);
}